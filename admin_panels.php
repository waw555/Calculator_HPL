    ...
    <section class="panel">
        ...
        <form method="post" enctype="multipart/form-data" id="panel-form">
            ...
            <div class="grid">
                ...
                <div><label>Валюта</label><select id="currency" name="currency"><?php foreach ($currencies as $cr): ?><option value="<?php echo e($cr['code']); ?>" data-rate="<?php echo e((string)$cr['rate_to_rub']); ?>" <?php echo ($editing['currency'] ?? 'RUB')===$cr['code']?'selected':''; ?>><?php echo e(app_currency_symbol((string)$cr['code'])); ?></option><?php endforeach; ?></select></div>
            </div>

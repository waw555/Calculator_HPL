...
<main class="container">
    ...
    <aside class="panel cost-card" aria-label="Стоимость материала и услуг распила">
        <div class="cost-card__section">
            <div class="cost-card__heading"><div class="cost-card__eyebrow">✦ Стоимость материала</div><div class="cost-card__total" id="material-cost-total">0,00 ₽</div></div>
        ...
        <div class="cost-card__section">
            <div class="cost-card__heading"><div class="cost-card__eyebrow">✦ Стоимость услуг распила</div><div class="cost-card__total" id="cost-total">0,00 ₽</div></div>

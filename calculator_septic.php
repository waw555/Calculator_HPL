...
<div id="shower-model-modal" class="shower-model-modal hidden" aria-hidden="true">
    <div class="shower-model-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="shower-model-modal-title">
        <div class="shower-model-modal__head">
            <h3 id="shower-model-modal-title">3D-модель душевой перегородки</h3>
            <button id="shower-model-modal-close" class="shower-model-modal__close" type="button" aria-label="Закрыть увеличенную модель">×</button>
        </div>
        <div class="shower-model-modal__canvas">
            <svg id="shower-model-modal-svg" viewBox="0 0 520 390" role="img" aria-label="Увеличенная трёхмерная модель душевой перегородки"></svg>
        </div>
        <p class="shower-model-modal__caption">Модель обновляется по выбранному декору и параметрам перегородки.</p>
    </div>
</div>

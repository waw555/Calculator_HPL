...
.calculation-filters{grid-template-columns:repeat(5,minmax(0,1fr))}.calculation-filters #collection-field{min-width:0}.calculation-filters .custom-format{grid-column:span 2}.calculation-filters .partition-type-field{grid-column:1}@media(max-width:1100px){.calculation-filters{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:760px){.calculation-filters{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:600px){.calculation-filters{grid-template-columns:1fr}.calculation-filters .custom-format{grid-column:span 1}}
</style>

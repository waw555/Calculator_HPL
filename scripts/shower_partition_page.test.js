...
assert.match(page, /Количество кабин, шт\./, 'Единица измерения количества кабин должна отображаться внутри поля');
assert.match(page, /id="shower_panel_count"/, 'Должно быть поле количества перегородок');
assert.match(page, /Количество перегородок, шт\./, 'Единица измерения количества перегородок должна отображаться внутри поля');
assert.match(page, /Количество дверей, шт\./, 'Единица измерения количества дверей должна отображаться внутри поля');

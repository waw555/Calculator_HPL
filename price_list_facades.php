...
<head>
<meta charset="UTF-8">
<title>Прайс-лист фасадных панелей</title>
<style>
...
<main class="container">
    <section class="panel">
        ...
        <p>Прайс-лист фасадных панелей ещё не опубликован. Для подбора и расчётов используйте раскрой панелей.</p>
        <a class="button" href="calculator_cutting.php">Открыть раскрой</a>
    </section>
</main>
</body>
</html>

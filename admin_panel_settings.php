...
<main class="container">
    ...
    <div class="cards">
        <section class="card">
            ...
            <h2>Панели</h2>
            <p>Справочник панелей: производитель, декор, фото, ценообразование и складская программа.</p>
            <a href="admin_panels.php">Открыть панели</a>
        </section>
    </div>
    ...
    <div class="cards">
        <section class="card">
            <div class="card-icon">🔧</div>
            <h2>Настройка расчёта столешниц</h2>
            <p>Толщина реза пилы и формула расчёта стоимости столешниц.</p>
            <a href="admin_countertop_settings.php">Открыть настройки</a>
        </section>
        <section class="card">
            <div class="card-icon">🏭</div>
            <h2>Тиснения</h2>
            <p>Полное и краткое название, производитель, изображение, складская программа и активность.</p>
            <a href="admin_panels.php?tab=embossings">Открыть тиснения</a>
        </section>
        <section class="card">
            <div class="card-icon">📐</div>
            <h2>Форматы панелей</h2>
            <p>Высота и ширина панели, объём, производитель, складская программа и активность.</p>
            <a href="admin_panels.php?tab=sizes">Открыть форматы</a>
        </section>
        <section class="card">
            <div class="card-icon">📏</div>
            <h2>Толщины панелей</h2>
            <p>Доступные толщины панелей с возможностью включения и отключения каждого значения.</p>
            <a href="admin_panels.php?tab=thicknesses">Открыть толщины</a>
        </section>
    </div>
